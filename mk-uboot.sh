...
EOF
	...
	tools/mkimage -n rk3399 -T rksd -d ../rkbin/rk33/rk3399_ddr_800MHz_v1.12.bin idbloader.img
	cat ../rkbin/rk33/rk3399_miniloader_v1.09.bin >> idbloader.img
	cp idbloader.img ${OUT}/u-boot/
	cp ../rkbin/rk33/rk3399_loader_v1.12.109.bin ${OUT}/u-boot/
...
[BL31_OPTION]
SEC=1
PATH=../rkbin/rk33/rk3399_bl31_v1.16.elf
ADDR=0x00010000
[BL32_OPTION]
SEC=1
PATH=../rkbin/rk33/rk3399_bl32_v1.10.bin
ADDR=0x08400000
[BL33_OPTION]
SEC=0
[OUTPUT]
